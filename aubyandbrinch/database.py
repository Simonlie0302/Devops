...
user_postgres = "dbname=postgres user=postgres password=docker"
# note_db_file_location = "database_file/notes.db"
# image_db_file_location = "database_file/images.db"

conn = psycopg2.connect(host="10.225.147.75", port=5432, database="postgres", user="postgres", password="docker")
